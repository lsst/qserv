...
There are two groups of attributes in the response object:

- The first group represents the common completion status of the request which is applicable to all REST services in Qserv.
  Attributes in this groups should be considered for all request types regardless of the request processing
...
These are the attributes of the first group:
...
These are the attributes of the second group:
