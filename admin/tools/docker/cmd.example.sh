# These commands require Docker on your machine
# and that you belong to docker group
...
# Below, we assume your Docker username is jdoe
# Create it here: https://hub.docker.com

# Create an image from a container
# Show all containers and choose one 
docker ps -all
