...
-- Variant of 1051_nn.sql that expresses the spatial join using
-- scisql_s2PtInCircle(...) = 1 instead of scisql_angSep(...) < r
...
-- withQserv WHERE qserv_areaspec_box(1.2, 3.3, 1.3, 3.4)
   AND scisql_s2PtInCircle(o1.ra_PS, o1.decl_PS, o2.ra_PS, o2.decl_PS, 0.016) = 1
