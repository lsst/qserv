...
-- ERROR 4110 (Proxy): Query processing error: QI=?: Failed to instantiate query: ParseException:Error parsing query, near "ROUND(ABS(iE1_SG),3)", qserv does not support functions in ORDER BY.
