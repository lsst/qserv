...
@qserv.command("env")
@click.option(envval_qserv_image.opt, is_flag=True)
@click.option(envval_build_image.opt, is_flag=True)
@click.option(envval_user_build_image.opt, is_flag=True)
@click.option(envval_run_base_image.opt, is_flag=True)
@click.option(envval_mariadb_image.opt, is_flag=True)
def show_qserv_environment(
    ...
    """
    if qserv_image:
        click.echo(envval_qserv_image.val())
    if build_image:
        click.echo(envval_build_image.val())
    if user_build_image:
        click.echo(envval_user_build_image.val())
    if run_base_image:
        click.echo(envval_run_base_image.val())
    if mariadb_image:
        click.echo(envval_mariadb_image.val())
...
@qserv.command()
@option_qserv_image(help=envval_qserv_image.help("The name and tag of the qserv run image to be built."))
@option_qserv_root()
@option_qserv_build_root()
@option_run_base_image(
    help=envval_run_base_image.help(
...
@qserv.command(help=f"""Build the qserv documentation.
    ...
    * {envval_ltd_user.env_var} - {envval_ltd_user.used_for}

    * {envval_ltd_password.env_var} - {envval_ltd_password.used_for}

    * {envval_gh_event_name.env_var} - {envval_gh_event_name.used_for}

    * {envval_gh_head_ref.env_var} - {envval_gh_head_ref.used_for}

    * {envval_gh_ref.env_var} - {envval_gh_ref.used_for}
...
def build_docs(
    ...
    launch.build_docs(
        upload=upload,
        ltd_user=envval_ltd_user.val(),
        ltd_password=envval_ltd_password.val(),
        gh_event=envval_gh_event_name.val(),
        gh_head_ref=envval_gh_head_ref.val(),
        gh_ref=envval_gh_ref.val(),
        qserv_root=qserv_root,
        qserv_build_root=qserv_build_root,
...
@qserv.command()
@option_build_image(help=envval_build_image.help("The name of the build base image to create."))
@option_push_image()
@option_pull_image()
@option_qserv_root()
@option_dry()
...
@qserv.command()
@option_run_base_image(help=envval_run_base_image.help("The name of the lite-run-base image to create."))
@option_push_image()
@option_pull_image()
@option_qserv_root()
@option_dry()
...
@qserv.command()
@option_mariadb_image(help=envval_mariadb_image.help("The name of the mariadb image to create."))
@option_push_image()
@option_pull_image()
@option_qserv_root()
@option_dry()
...
@qserv.command()
@option_build_image(help=envval_build_image.help("The name of the build base image to create."))
@option_user_build_image(help=envval_run_base_image.help("The name of the lite-run-base image to create."))
@option_qserv_group()
@option_run_base_image(help=envval_run_base_image.help("The name of the lite-run-base image to create."))
@option_mariadb_image(help=envval_mariadb_image.help("The name of the mariadb image to create."))
...
@option_qserv_image()
@option_mariadb_image(
    help=envval_mariadb_image.help("The name of the database image to use for the reference database.")
)
@option_qserv_root()
@option_project()
@option_itest_container_name()
...
def dh_image_exists(image: str) -> None:
    user = envval_dh_user.val()
    token = envval_dh_token.val()
