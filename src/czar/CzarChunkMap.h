...
///
/// This class is generated in CzarFamilyMap _read() and _insertIntoMaps(...).
/// Once generate, the CzarChunkMap created is constant. The new CzarChunkMap
/// object replaces the old one. This allows access without mutex
/// protection, which helps when millions of jobs need to be directed
/// to the proper worker quickly.
///
