...
public:
    ...
    void unlock(ccontrol::UserQuery::Ptr const& userQuery, bool completeSuccess);

protected:
private:
    /// store all messages from current session to the table
    void _saveQueryMessages(ccontrol::UserQuery::Ptr const& userQuery, bool completeSuccess);
