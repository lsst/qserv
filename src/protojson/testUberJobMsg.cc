...
bool parseSerializeReparseCheck(string const& jsStr, string const& note) {
    ...
    nlohmann::json jsUjm = ujm->toJson();
    ...
    nlohmann::json jsUjmCreated = ujmCreated->toJson();
