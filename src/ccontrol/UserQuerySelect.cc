...
UserQuerySelect::UserQuerySelect(shared_ptr<qproc::QuerySession> const& qs,
                                 ...
                                 shared_ptr<qmeta::QProgress> const& queryProgress, qmeta::CzarId czarId,
...
void UserQuerySelect::_setupChunking() {
    ...
    shared_ptr<IntSet const> eSet = _qSession->getEmptyChunks();
    {
    ...
    if (_qSession->hasChunks()) {
        ...
        im = make_shared<qproc::IndexMap>(partStriping, _secondaryIndex);
