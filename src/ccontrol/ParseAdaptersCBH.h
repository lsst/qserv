...
#ifndef LSST_QSERV_CCONTROL_PARSEADAPTERSCBH_H
#define LSST_QSERV_CCONTROL_PARSEADAPTERSCBH_H
...
public:
    virtual void HandleFullColumnNameExpressionAtom(
            std::shared_ptr<query::ValueFactor> const& valueFactor) = 0;
};
...
public:
    virtual void handleAggregateWindowedFunction(
            std::shared_ptr<query::ValueFactor> const& aggValueFactor) = 0;
};
