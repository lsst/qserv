...
int main(int argc, char* argv[]) {
    czar2::HttpCzarConfig httpCzarConfig;
    ...
    try {
        auto const czar = czar2::Czar::createCzar(configFilePath, czarName);
        ...
        auto const svc = czar2::HttpCzarSvc::create(httpCzarConfig);
        if (verbose) {
