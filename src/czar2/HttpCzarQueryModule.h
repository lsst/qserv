 ...
 */
#ifndef LSST_QSERV_CZAR2_HTTPCZARQUERYMODULE_H
#define LSST_QSERV_CZAR2_HTTPCZARQUERYMODULE_H
 ...
 */
class HttpCzarQueryModule : public czar2::ChttpModule {
public:
    /**
...
#endif  // LSST_QSERV_CZAR2_HTTPCZARQUERYMODULE_H
