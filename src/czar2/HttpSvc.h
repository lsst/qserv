 ...
 */
#ifndef LSST_QSERV_CZAR2_HTTPSVC_H
#define LSST_QSERV_CZAR2_HTTPSVC_H
...
/**
 * Class HttpSvc is the HTTP server for processing Czar management requests.
 *
 ...
 *   auto const svc = czar2::HttpSvc::create(port, numThreads);
 *
...
#endif  // LSST_QSERV_CZAR2_HTTPSVC_H
