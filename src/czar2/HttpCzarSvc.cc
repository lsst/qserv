...
#include "czar2/HttpCzarIngestModule.h"
#include "czar2/HttpCzarQueryModule.h"
#include "czar2/WorkerIngestProcessor.h"
#include "http/Auth.h"
...
void HttpCzarSvc::startAndWait() {
    string const context = "czar2::HttpCzarSvc::" + string(__func__) + " ";
...
void HttpCzarSvc::_registerHandlers() {
    ::throwIf<logic_error>(_svr == nullptr,
                           "czar2::HttpCzarSvc::" + string(__func__) + " the server is not initialized");
