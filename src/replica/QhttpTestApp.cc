...
QhttpTestApp::Ptr QhttpTestApp::create(int argc, char* argv[]) {
    return Ptr(new QhttpTestApp(argc, argv));
}
...
int QhttpTestApp::runImpl() {
    ...
    while(!stop) {
        ...
        double const requestsPerSecond = (endNumRequests - beginNumRequests) /
