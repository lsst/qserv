 ...
 */
#ifndef LSST_QSERV_REPLICA_CONFIGTESTDATACONTROLLER_H
#define LSST_QSERV_REPLICA_CONFIGTESTDATACONTROLLER_H
...
/**
 * This utility class ConfigTestDataController provides inputs for testing the Configuration
 * service used by the Controller.
 */
class ConfigTestDataController {
public:
...
#endif  // LSST_QSERV_REPLICA_CONFIGTESTDATACONTROLLER_H
