...
json ConfigTestDataController::data() {
    ...
    generalObj["controller"] = json::object({{"name", "test-master"},
                                             ...
                                             {"czar-response-timeout", 180},
                                             {"worker-response-timeout", 240},
                                             {"worker-config-timeout", 360},
                                             {"worker-evict-timeout", 720},
                                             {"qserv-sync-timeout", 1440},
                                             {"qserv-sync-disable", 1},
                                             {"qserv-sync-force", 1},
                                             {"purge-excess-replicas", 1},
                                             {"chunk-map-update", 1},
                                             {"permanent-worker-delete", 1},
                                             {"http-root", "/tmp/http"},
    ...
    generalObj["database"] = json::object({{"host", "localhost"},
                                           ...
                                           {"czar-db-conn", "mysql://qsmaster@host-B:3306/qservMeta"}});
    ...
    obj["workers"] = json::array();
    {
        ...
        json worker = json::object({{"name", "worker-A"},
                                    ...
                                    {"svc-port", 51001},
                                    {"http-svc-host", {{"addr", "127.0.0.1"}, {"name", "host-A"}}},
                                    {"http-svc-port", 56001},
    ...
    }
    {
        ...
        json worker = json::object({{"name", "worker-B"},
                                    ...
                                    {"http-svc-host", {{"addr", "168.1.1.1"}, {"name", "host-B"}}},
    ...
    }
    {
        ...
        json worker = json::object({{"name", "worker-C"},
                                    ...
                                    {"http-svc-host", {{"addr", "168.1.1.7"}, {"name", "host-C7"}}},
