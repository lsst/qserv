 ...
 */
#ifndef LSST_QSERV_REPLICA_CONFIGTESTDATAWORKER_H
#define LSST_QSERV_REPLICA_CONFIGTESTDATAWORKER_H
...
/**
 * This utility class ConfigTestDataWorker provides inputs for testing the Configuration
 * service used by the Worker.
 */
class ConfigTestDataWorker {
public:
...
#endif  // LSST_QSERV_REPLICA_CONFIGTESTDATAWORKER_H
