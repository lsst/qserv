...
private:
    ...
    uint64_t const _delay;    ///< The amount of the initial delay (milliseconds)
    std::string const _data;  ///< The message to be echoed back to the client

    uint64_t _delayLeft;  ///< The amount of the initial delay which is still left  (milliseconds)
};
