...
// #include "replica/worker/WorkerHttpDeleteRequest.h"
// #include "replica/worker/WorkerHttpEchoRequest.h"
// #include "replica/worker/WorkerHttpFindRequest.h"
// #include "replica/worker/WorkerHttpFindAllRequest.h"
// #include "replica/worker/WorkerHttpReplicationRequest.h"
// #include "replica/worker/WorkerHttpSqlRequest.h"
// #include "replica/worker/WorkerHttpDirectorIndexRequest.h"
...
void WorkerHttpProcessor::run() {
    ...
    if (_state == protocol::ServiceState::SUSPENDED) {
        size_t const numThreads =
                _serviceProvider->config()->get<size_t>("worker", "num-http-svc-processing-threads");
        if (not numThreads) {
