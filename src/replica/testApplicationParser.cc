...
BOOST_AUTO_TEST_CASE(ApplicationParser1) {
    ...
    BOOST_REQUIRE_NO_THROW({ Parser parser(argc, argv, descr); });
...
BOOST_AUTO_TEST_CASE(ApplicationParser2) {
    ...
    BOOST_REQUIRE_NO_THROW({
        ...
        LOGS_INFO("ApplicationParser: parsed values  r1=" + r1 + " r2=" + to_string(r2) +
                  " r3=" + to_string(r3) + " r4=" + to_string(r4) + " r5=" + to_string(r5) +
                  " r6=" + string(r6 ? "true" : "false") + " o1=" + o1 + " o2=" + o2 + " o3=" + o3 +
                  " f1=" + string(f1 ? "true" : "false") + " f2=" + string(f2 ? "true" : "false") +
...
BOOST_AUTO_TEST_CASE(ApplicationParser4) {
    ...
    BOOST_REQUIRE_NO_THROW({
        ...
        LOGS_INFO("ApplicationParser: input strings  " + parser.serializeArguments());
        LOGS_INFO("ApplicationParser: parsed values  command=" + command + " r1=" + r1 +
                  " r2=" + to_string(r2) + " r3=" + to_string(r3) + " r4=" + to_string(r4) +
                  " r5=" + to_string(r5) + " r6=" + string(r6 ? "true" : "false") + " c1r1=" + c1r1 +
                  " o1=" + o1 + " c1o1=" + to_string(c1o1));
    ...
    BOOST_REQUIRE_NO_THROW({
        ...
        LOGS_INFO("ApplicationParser: parsed values  command=" + command + " r1=" + r1 +
                  " r2=" + to_string(r2) + " r3=" + to_string(r3) + " r4=" + to_string(r4) +
                  " r5=" + to_string(r5) + " r6=" + string(r6 ? "true" : "false") + " c2r1=" + c2r1 +
                  " o1=" + o1 + " c2f1=" + string(c2f1 ? "true" : "false"));
    ...
    BOOST_REQUIRE_NO_THROW({
        ...
        LOGS_INFO("ApplicationParser: input strings  " + parser.serializeArguments());
        LOGS_INFO("ApplicationParser: parsed values  command=" + command + " r1=" + r1 + " r2=" +
                  to_string(r2) + " r3=" + to_string(r3) + " r4=" + to_string(r4) + " r5=" + to_string(r5) +
                  " r6=" + string(r6 ? "true" : "false") + " o1=" + o1 + " c3o1=" + to_string(c3o1));
    ...
    char const* const argvHelp[] = {"testApplicationParser", "--help"};
    BOOST_REQUIRE_NO_THROW({
