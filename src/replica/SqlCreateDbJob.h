 ...
 */
#ifndef LSST_QSERV_REPLICA_SQLCREATEDBJOB_H
#define LSST_QSERV_REPLICA_SQLCREATEDBJOB_H
...
private:
    ...
    SqlCreateDbJob(std::string const& database, bool allWorkers, Controller::Ptr const& controller,
                   std::string const& parentJobId, CallbackType const& onFinish, int priority);
