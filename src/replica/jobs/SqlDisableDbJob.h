 ...
 */
#ifndef LSST_QSERV_REPLICA_SQLDISABLEDBJOB_H
#define LSST_QSERV_REPLICA_SQLDISABLEDBJOB_H
...
public:
     ...
     * low-level pointers).
     *
     * @param database the name of a database to be disabled
...
private:
    SqlDisableDbJob(std::string const& database, bool allWorkers, Controller::Ptr const& controller,
                    std::string const& parentJobId, CallbackType const& onFinish, int priority);
...
#endif  // LSST_QSERV_REPLICA_SQLDISABLEDBJOB_H
