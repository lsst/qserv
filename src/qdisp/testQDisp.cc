...
public:
    ...
    SetupTest(const char* request, util::QdispPool::Ptr const& qPool_) : qdispPool(qPool_) {
        ...
        std::shared_ptr<qmeta::QProgress> qProgress;  // No updating QStatus, nullptr
        ex = qdisp::ExecutiveUT::PtrUT(new qdisp::ExecutiveUT(60, ms, qdispPool, qProgress, nullptr, testInfo));
