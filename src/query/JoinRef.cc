...
std::ostream& operator<<(std::ostream& os, JoinRef const& js) {
    ...
    switch (js._joinType) {
        default:
            os << "!!unhandled!!";
            break;
        case JoinRef::DEFAULT:
            os << "query::JoinRef::DEFAULT";
            break;
        case JoinRef::INNER:
            os << "query::JoinRef::INNER";
            break;
        case JoinRef::LEFT:
            os << "query::JoinRef::LEFT";
            break;
        case JoinRef::RIGHT:
            os << "query::JoinRef::RIGHT";
            break;
        case JoinRef::FULL:
            os << "query::JoinRef::FULL";
            break;
        case JoinRef::CROSS:
            os << "query::JoinRef::CROSS";
            break;
        case JoinRef::UNION:
            os << "query::JoinRef::UNION";
            break;
    }
    os << ", ";
...
std::ostream& operator<<(std::ostream& os, JoinRef const* js) { return js->putStream(os); }

bool JoinRef::operator==(const JoinRef& rhs) const {
    return util::ptrCompare<TableRef>(_right, rhs._right) && _joinType == rhs._joinType &&
