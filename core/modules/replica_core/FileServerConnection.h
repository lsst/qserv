 ...
 */
#ifndef LSST_QSERV_REPLICA_CORE_FILESERVERCONNECTION_H
#define LSST_QSERV_REPLICA_CORE_FILESERVERCONNECTION_H
...
private:
     ...
     */
    void requestReceived (const boost::system::error_code &ec,
     ...
     */
    void responseSent (const boost::system::error_code &ec,
                       size_t                           bytes_transferred);
     ...
     * The calback on finishing (either successfully or not) of aynchronious writes.
     */
    void dataSent (const boost::system::error_code &ec,
                   size_t                           bytes_transferred);
...
#endif // LSST_QSERV_REPLICA_CORE_FILESERVERCONNECTION_H