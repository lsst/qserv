...
#ifndef LSST_QSERV_CCONTROL_USERQUERYSHOW_H
#define LSST_QSERV_CCONTROL_USERQUERYSHOW_H
...
class UserQueryShow : public UserQuery {
public:

    enum Entity { DATABASES };

    UserQueryShow(UserQueryConfig const& queryConfig, Entity entity);

    virtual ~UserQueryShow() {}
...
#endif // LSST_QSERV_CCONTROL_USERQUERYSHOW_H
