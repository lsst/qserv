...
bool MergingHandler::_setResult() {
    ...
    auto protoEnd = std::chrono::system_clock::now(); // &&& delete, probably
    auto protoDur = std::chrono::duration_cast<std::chrono::milliseconds>(protoEnd - start); // &&& delete, probably
