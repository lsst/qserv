...
#ifndef LSST_QSERV_WCONTROL_REMOVE_CHUNK_GROUP_COMMAND_H
#define LSST_QSERV_WCONTROL_REMOVE_CHUNK_GROUP_COMMAND_H
...
#endif // LSST_QSERV_WCONTROL_REMOVE_CHUNK_GROUP_COMMAND_H