...
#ifndef LSST_QSERV_UTIL_STRINGTOVECTOR_H
#define LSST_QSERV_UTIL_STRINGTOVECTOR_H
...
std::vector<std::string> splitString(std::string const& str, std::string const& separator);
...
std::vector<int> getIntVectFromStr(std::string const& str, std::string const& separator, bool throwOnError=true, int defaultVal=0);

}}} // namespace lsst::qserv::util

#endif // LSST_QSERV_UTIL_STRINGTOVECTOR_H
