...
class QueryProcessingBug : public std::runtime_error {
public:
    explicit QueryProcessingBug(char const* msg) : std::runtime_error(msg) {}
    explicit QueryProcessingBug(std::string const& msg) : std::runtime_error(msg) {}
};
