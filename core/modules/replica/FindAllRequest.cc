...
FindAllRequestC::pointer FindAllRequestC::create(ServiceProvider::pointer const& serviceProvider,
    ...
    return FindAllRequestC::pointer(
        new FindAllRequestC(serviceProvider,
                            io_service,
                            worker,
                            database,
                            onFinish,
...
void FindAllRequestC::beginProtocol() {
...
void FindAllRequestC::requestSent(boost::system::error_code const& ec,
...
void FindAllRequestC::receiveResponse() {
...
void FindAllRequestC::responseReceived(boost::system::error_code const& ec,
                                       size_t bytes_transferred) {
...
void FindAllRequestC::awaken(boost::system::error_code const& ec) {
...
void FindAllRequestC::sendStatus() {
...
void FindAllRequestC::statusSent(boost::system::error_code const& ec,
                                 size_t bytes_transferred) {
...
void FindAllRequestC::receiveStatus() {
...
void FindAllRequestC::statusReceived(boost::system::error_code const& ec,
                                     size_t bytes_transferred) {
...
void FindAllRequestC::analyze(proto::ReplicationResponseFindAll const& message) {
