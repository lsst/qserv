...
namespace {
string const description = "The test application for the command line framework.";
} /// namespace
...
TestApp::Ptr TestApp::create(int argc, char* argv[]) {
    return Ptr(new TestApp(argc, argv));
}
