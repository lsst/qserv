...
void StatusRequestBaseC::beginProtocol() {
...
void StatusRequestBaseC::requestSent(boost::system::error_code const& ec,
...
void StatusRequestBaseC::receiveResponse() {
...
void StatusRequestBaseC::responseReceived(boost::system::error_code const& ec,
                                          size_t bytes_transferred) {
...
void StatusRequestBaseC::awaken(boost::system::error_code const& ec) {
...
void StatusRequestBaseC::sendStatus() {
...
void StatusRequestBaseC::statusSent(boost::system::error_code const& ec,
                                    size_t bytes_transferred) {
...
void StatusRequestBaseC::receiveStatus() {
...
void StatusRequestBaseC::statusReceived(boost::system::error_code const& ec,
                                        size_t bytes_transferred) {
...
void StatusRequestBaseC::analyze(proto::ReplicationStatus status) {
    ...
    switch (status) {
        ...
        default:
            throw std::logic_error(
                    "StatusRequestBaseC::analyze() unknown status '" +
                    proto::ReplicationStatus_Name(status) +
