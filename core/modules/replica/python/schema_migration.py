...
class QservReplicaMigrationManager(SchemaMigMgr):
    """Class implementing schema migration for qservReplica database.
    """
    ...
    def __init__(self, name, engine, scripts_dir):
        ...
        # scripts are located in replica/ sub-dir
    ...
    def current_version(self):
        ...
        # Initial qservReplica implementation did not have version number stored at all,
...
def make_migration_manager(name, engine, scripts_dir):
    """Factory method for qservReplica schema migration manager
    ...
    """
    return QservReplicaMigrationManager(name, engine, scripts_dir)
