...
BOOST_AUTO_TEST_CASE(ConfigurationTest) {
    ...
    BOOST_CHECK(addedWorkerE.svcPort == config->workerDefaultSvcPort());
    BOOST_CHECK(addedWorkerE.fsHost == workerF.svcHost);
    BOOST_CHECK(addedWorkerE.fsPort == config->workerDefaultFsPort());
    BOOST_CHECK(addedWorkerE.dataDir == config->workerDefaultDataDir());
    BOOST_CHECK(addedWorkerE.dbHost == workerF.svcHost);
    BOOST_CHECK(addedWorkerE.dbPort == config->workerDefaultDbPort());
    BOOST_CHECK(addedWorkerE.dbUser == config->workerDefaultDbUser());
    BOOST_CHECK(addedWorkerE.loaderHost == workerF.svcHost);
    BOOST_CHECK(addedWorkerE.loaderPort == config->workerDefaultLoaderPort());
    BOOST_CHECK(addedWorkerE.loaderTmpDir == config->workerDefaultLoaderTmpDir());
    BOOST_CHECK(addedWorkerE.exporterHost == workerF.svcHost);
    BOOST_CHECK(addedWorkerE.exporterPort == config->workerDefaultExporterPort());
    BOOST_CHECK(addedWorkerE.exporterTmpDir == config->workerDefaultExporterTmpDir());
    BOOST_CHECK(addedWorkerE.httpLoaderHost == workerF.svcHost);
    BOOST_CHECK(addedWorkerE.httpLoaderPort == config->workerDefaultHttpLoaderPort());
    BOOST_CHECK(addedWorkerE.httpLoaderTmpDir == config->workerDefaultHttpLoaderTmpDir());
