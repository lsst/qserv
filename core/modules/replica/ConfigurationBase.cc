...
size_t       const ConfigurationBase::defaultHttpLoaderNumProcessingThreads = 1;
...
string       const ConfigurationBase::defaultWorkerHttpLoaderHost         = "localhost";
uint16_t     const ConfigurationBase::defaultWorkerHttpLoaderPort         = 50004;
string       const ConfigurationBase::defaultWorkerHttpLoaderTmpDir       = "tmp/{worker}";
...
ConfigurationBase::ConfigurationBase()
    :   _requestBufferSizeBytes     (defaultRequestBufferSizeBytes),
        ...
        _httpLoaderNumProcessingThreads(defaultHttpLoaderNumProcessingThreads),
...
string ConfigurationBase::asString() const {
    ...
    ss << context() << "defaultHttpLoaderNumProcessingThreads: " << defaultHttpLoaderNumProcessingThreads << "\n";
    ...
    ss << context() << "defaultWorkerHttpLoaderHost:          " << defaultWorkerHttpLoaderHost << "\n";
    ss << context() << "defaultWorkerHttpLoaderPort:          " << defaultWorkerHttpLoaderPort << "\n";
    ss << context() << "defaultWorkerHttpLoaderTmpDir:        " << defaultWorkerHttpLoaderTmpDir << "\n";
    ...
    ss << context() << "_httpLoaderNumProcessingThreads:      " << _httpLoaderNumProcessingThreads << "\n";
