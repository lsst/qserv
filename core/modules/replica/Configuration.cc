...
size_t Configuration::requestBufferSizeBytes() const {
    return get<size_t>("common", "request_buf_size_bytes");
}


void Configuration::setRequestBufferSizeBytes(size_t val) {
    set<size_t>("common", "request_buf_size_bytes"));
}


unsigned int Configuration::retryTimeoutSec() const {
    return get<size_t>("common", "request_retry_interval_sec");
}


void Configuration::setRetryTimeoutSec(unsigned int val) {
    set<unsigned int>("common", "request_retry_interval_sec"));
}


size_t Configuration::controllerThreads() const {
    return get<size_t>("controller", "num_threads");
}


void Configuration::setControllerThreads(size_t val) {
    set<size_t>("controller", "num_threads"));
}


uint16_t Configuration::controllerHttpPort() const {
    return get<size_t>("controller", "http_server_port");
}


void Configuration::setControllerHttpPort(uint16_t val) {
    set<uint16_t>("controller", "http_server_port"));
}


size_t Configuration::controllerHttpThreads() const {
    return get<size_t>("controller", "http_server_threads");
}


void Configuration::setControllerHttpThreads(size_t val) {
    set<size_t>("controller", "http_server_threads"));
}


unsigned int Configuration::controllerRequestTimeoutSec() const {
    return get<unsigned int>("controller", "request_timeout_sec");
}


void Configuration::setControllerRequestTimeoutSec(
        unsigned int val, bool updatePersistentState)
{
    set<unsigned int>("controller", "request_timeout_sec"),
                      updatePersistentState);
}


string Configuration::controllerEmptyChunksDir() const {
    return get<string>("controller", "empty_chunks_dir");
}


unsigned int Configuration::jobTimeoutSec() const {
    return get<unsigned int>("controller", "job_timeout_sec");
}


void Configuration::setJobTimeoutSec(unsigned int val) {
    set<unsigned int>("controller", "job_timeout_sec"));
}


unsigned int Configuration::jobHeartbeatTimeoutSec() const {
    return get<unsigned int>("controller", "job_heartbeat_sec");
}


void Configuration::setJobHeartbeatTimeoutSec(unsigned int val) {
    set<unsigned int>("controller", "job_heartbeat_sec", val);
}


bool Configuration::xrootdAutoNotify() const {
    return get<unsigned int>("xrootd", "auto_notify") != 0;
}


void Configuration::setXrootdAutoNotify(bool val) {
    set<unsigned int>("xrootd", "auto_notify", val ? 1 : 0);
}


string Configuration::xrootdHost() const {
    return get<string>("xrootd", "host");
}


void Configuration::setXrootdHost(string const& val) {
    set<string>("xrootd", "host"));
}


uint16_t Configuration::xrootdPort() const {
    return get<uint16_t>("xrootd", "port");
}


void Configuration::setXrootdPort(uint16_t val) {
    set<uint16_t>("xrootd", "port"));
}


unsigned int Configuration::xrootdTimeoutSec() const {
    return get<unsigned int>("xrootd", "request_timeout_sec");
}


void Configuration::setXrootdTimeoutSec(unsigned int val,
                                        bool updatePersistentState) {
    set<unsigned int>("xrootd", "request_timeout_sec"),
                      updatePersistentState);
}


string Configuration::databaseHost() const {
    return get<string>("database", "host");
}


uint16_t Configuration::databasePort() const {
    return get<uint16_t>("database", "port");
}


string Configuration::databaseUser() const {
    return get<string>("database", "user");
}


string Configuration::databasePassword() const {
    return get<string>("database", "password");
}


string Configuration::databaseName() const {
    return get<string>("database", "name");
}


size_t Configuration::databaseServicesPoolSize() const {
    return get<size_t>("database", "services_pool_size");
}


void Configuration::setDatabaseServicesPoolSize(size_t val) {
    set<size_t>("database", "services_pool_size"));
}


string Configuration::qservMasterDatabaseHost() const {
    return get<string>("database", "qserv_master_host");
}


void Configuration::setQservMasterDatabaseHost(string const& val) {
    set<string>("database", "qserv_master_host"));
}


uint16_t Configuration::qservMasterDatabasePort() const {
    return get<uint16_t>("database", "qserv_master_port");
}


void Configuration::setQservMasterDatabasePort(uint16_t val) {
    set<uint16_t>("database", "qserv_master_port"));
}


string Configuration::qservMasterDatabaseUser() const {
    return get<string>("database", "qserv_master_user");
}


void Configuration::setQservMasterDatabaseUser(string const& val) {
    set<string>("database", "qserv_master_user"));
}


string Configuration::qservMasterDatabaseName() const {
    return get<string>("database", "qserv_master_name");
}


void Configuration::setQservMasterDatabaseName(string const& val) {
    set<string>("database", "qserv_master_name"));
}


size_t Configuration::qservMasterDatabaseServicesPoolSize() const {
    return get<size_t>("database", "qserv_master_services_pool_size");
}


void Configuration::setQservMasterDatabaseServicesPoolSize(size_t val) {
    set<size_t>("database", "qserv_master_services_pool_size"));
}


string Configuration::qservMasterDatabaseTmpDir() const {
    return get<string>("database", "qserv_master_tmp_dir");
}


void Configuration::setQservMasterDatabaseTmpDir(string const& val) {
    set<string>("database", "qserv_master_tmp_dir"));
}
...
string Configuration::workerTechnology() const {
    return get<string>("worker", "technology");
}


void Configuration::setWorkerTechnology(string const& val) {
    set<string>("worker", "technology"));
}
...
size_t Configuration::workerNumProcessingThreads() const {
    return get<size_t>("worker", "num_svc_processing_threads");
}


void Configuration::setWorkerNumProcessingThreads(size_t val) {
    set<size_t>("worker", "num_svc_processing_threads"));
}


size_t Configuration::fsNumProcessingThreads() const {
    return get<size_t>("worker", "num_fs_processing_threads");
}


void Configuration::setFsNumProcessingThreads(size_t val) {
    set<size_t>("worker", "num_fs_processing_threads"));
}


size_t Configuration::workerFsBufferSizeBytes() const {
    return get<size_t>("worker", "fs_buf_size_bytes");
}


void Configuration::setWorkerFsBufferSizeBytes(size_t val) {
    set<size_t>("worker", "fs_buf_size_bytes"));
}


size_t Configuration::loaderNumProcessingThreads() const {
    return get<size_t>("worker", "num_loader_processing_threads");
}


void Configuration::setLoaderNumProcessingThreads(size_t val) {
    set<size_t>("worker", "num_loader_processing_threads"));
}


size_t Configuration::exporterNumProcessingThreads() const {
    return get<size_t>("worker", "num_exporter_processing_threads");
}


void Configuration::setExporterNumProcessingThreads(size_t val) {
    set<size_t>("worker", "num_exporter_processing_threads"));
}


size_t Configuration::httpLoaderNumProcessingThreads() const {
    return get<size_t>("worker", "num_http_loader_processing_threads");
}


void Configuration::setHttpLoaderNumProcessingThreads(size_t val) {
    set<size_t>("worker", "num_http_loader_processing_threads"));
}



uint16_t Configuration::workerDefaultSvcPort() const {
    return get<uint16_t>("worker_defaults", "svc_port");
}
void Configuration::setWorkerDefaultSvcPort(uint16_t val) {
    set<uint16_t>("worker_defaults", "svc_port"));
}


uint16_t Configuration::workerDefaultFsPort() const {
    return get<uint16_t>("worker_defaults", "fs_port");
}
void Configuration::setWorkerDefaultFsPort(uint16_t val) {
    set<uint16_t>("worker_defaults", "fs_port"));
}


string Configuration::workerDefaultDataDir() const {
    return get<string>("worker_defaults", "data_dir");
}


void Configuration::setWorkerDefaultDataDir(string const& val) {
    set<string>("worker_defaults", "data_dir"));
}


uint16_t Configuration::workerDefaultDbPort() const {
    return get<uint16_t>("worker_defaults", "db_port");
}


void Configuration::setWorkerDefaultDbPort(uint16_t val) {
    set<uint16_t>("worker_defaults", "db_port"));
}


string Configuration::workerDefaultDbUser() const {
    return get<string>("worker_defaults", "db_user");
}


void Configuration::setWorkerDefaultDbUser(string const& val) {
    set<string>("worker_defaults", "db_user"));
}


uint16_t Configuration::workerDefaultLoaderPort() const {
    return get<uint16_t>("worker_defaults", "loader_port");
}


void Configuration::setWorkerDefaultLoaderPort(uint16_t val) {
    set<uint16_t>("worker_defaults", "loader_port"));
}


string Configuration::workerDefaultLoaderTmpDir() const {
    return get<string>("worker_defaults", "loader_tmp_dir");
}


void Configuration::setWorkerDefaultLoaderTmpDir(string const& val) {
    set<string>("worker_defaults", "loader_tmp_dir"));
}


uint16_t Configuration::workerDefaultExporterPort() const {
    return get<uint16_t>("worker_defaults", "exporter_port");
}


void Configuration::setWorkerDefaultExporterPort(uint16_t val) {
    set<uint16_t>("worker_defaults", "exporter_port"));
}


string Configuration::workerDefaultExporterTmpDir() const {
    return get<string>("worker_defaults", "exporter_tmp_dir");
}


void Configuration::setWorkerDefaultExporterTmpDir(string const& val) {
    set<string>("worker_defaults", "exporter_tmp_dir"));
}


uint16_t Configuration::workerDefaultHttpLoaderPort() const {
    return get<uint16_t>("worker_defaults", "http_loader_port");
}


void Configuration::setWorkerDefaultHttpLoaderPort(uint16_t val) {
    set<uint16_t>("worker_defaults", "http_loader_port"));
}


string Configuration::workerDefaultHttpLoaderTmpDir() const {
    return get<string>("worker_defaults", "http_loader_tmp_dir");
}


void Configuration::setWorkerDefaultHttpLoaderTmpDir(string const& val) {
    set<string>("worker_defaults", "http_loader_tmp_dir"));
}
