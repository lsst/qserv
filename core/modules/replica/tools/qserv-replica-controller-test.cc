...
/// qserv-replica-controller-test.cc is a test application for testing
/// the Controller. The application instantiates the Controller and then launches
/// a serious of requests from many treads.
...
LOG_LOGGER _log = LOG_GET("lsst.qserv.replica.tools.qserv-replica-controller-test");
